...
*   `coal` (12) $\rightarrow$ **`[[kr-crush-coal]]`** $\rightarrow$ `rx-crushed-coal` (18) | ⏳ 4s (Pure Coal Powder)
...
*   `kr-oxygen-gas` (200) + `kr-nitric-acid` (40) + `rx-crushed-coal` (4) $\rightarrow$ **`[[rx-solid-oxidizer-production]]`** $\rightarrow$ `rx-solid-oxidizer` (2) | ⏳ 12s in Electrolysis (`kr-electrolysis`)
*   `kr-sand` (12) + `rx-crushed-coal` (3) + `kr-hydrogen-chloride` (30) $\rightarrow$ **`[[rx-advanced-quartz-electrolysis]]`** $\rightarrow$ `kr-quartz` (18) + `chlorine` (20) | ⏳ 8s in Electrolysis (`kr-electrolysis`)
...
*   `rx-enriched-steel-mix` (6) + `rx-crushed-coal` (3) + `rx-solid-oxidizer` (3) $\rightarrow$ **`[[rx-purified-steel-melting]]`** $\rightarrow$ `steel-plate` (9) | ⏳ 195.3s
*   `kr-quartz` (6) + `rx-crushed-coal` (3) + `kr-glass` (1) $\rightarrow$ **`[[rx-purified-glass-melting]]`** $\rightarrow$ `kr-glass` (9) | ⏳ 119.7s
*   `kr-quartz` (6) + `rx-crushed-coal` (3) + `rx-solid-oxidizer` (3) $\rightarrow$ **`[[rx-purified-silicon-melting]]`** $\rightarrow$ `kr-silicon` (9) | ⏳ 113.4s

#### 5. Multi-Industry Integration Tracks
*   `steel-plate` (2) + `rx-wood-pulp` (4) + `rx-crushed-coal` (2) + `kr-biomass` (3) $\rightarrow$ **`[[kr-pollution-filter]]`** (1) | ⏳ 4s
*   `kr-used-pollution-filter` (1) + `rx-wood-pulp` (3) + `rx-crushed-coal` (1) + `water` (30) $\rightarrow$ **`[[kr-recharged-pollution-filter]]`** $\rightarrow$ `kr-pollution-filter` (1) + `kr-dirty-water` (20) | ⏳ 6s inside `kr-biomedical`
